...
(function() {
  ...
  // when you know that your board values will be unique.
  ...
  // Returns the first board on an array-like that passes a predicate test
  ...
  // Use a comparator function to figure out the smallest board at which
